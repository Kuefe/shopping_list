...
class ShoppingListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter =
            ShoppingListAdapter(ShoppingListAdapter.OnClickListener { viewModel.displayArticle(it) })
        ...
        viewModel.navigateToSelectedArticle.observe(viewLifecycleOwner, Observer {
            Timber.i("Timber: navigateToSelectedArticle")
            if (null != it) {
        ...
        viewModel.articleList.observe(viewLifecycleOwner, Observer {
            Timber.i("Timber: viewModel.articleList.observe")
            it?.let {
        ...
        val itemTouchHelperCallback = object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, position: Int) {
                val article = adapter.getItem(viewHolder)
                val countOfArticles = viewModel.deleteArticle(article)
                adapter.removeItem(viewHolder, countOfArticles)
